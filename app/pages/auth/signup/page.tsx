...
export default function signupPage(){
    ...
    >
      <div className="mx-auto w-full max-w-sm lg:w-96">
        <div>
          <h2 className="mt-6 text-3xl font-extrabold">Join the Band</h2>
          <p className="mt-2 text-sm text-gray-400">
            Sign up to join chuflay!
          </p>
        </div>
              ...
              />
                ...
                <div className="flex items-center">
                  ...
                  <label htmlFor="terms" className="ml-2 block text-sm text-gray-300">
                    I agree to the <a href="#" className="text-red-500 hover:text-red-400">Terms</a> and <a href="#" className="text-red-500 hover:text-red-400">Privacy Policy</a>
                  </label>
                </div>
        ...
        <div className="mt-6">
          <p className="text-center text-sm text-gray-400">
            ...
            <Link href="/pages/auth/login" className="font-medium text-red-500 hover:text-red-400">
            Sign in
            </Link>
          </p>
        </div>
